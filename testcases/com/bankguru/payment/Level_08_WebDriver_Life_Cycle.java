...
public class Level_08_WebDriver_Life_Cycle extends AbstractPages {
	WebDriver driver;
	...
	@Test
	public void TC_01_OpenPageInMenu() {
		editCustomerPage = homePage1.openEditCustomerPage(driver);

		deleteAccountPage = editCustomerPage.openDeleteAcountPage(driver);

		homePage1 = deleteAccountPage.openHomePage(driver);

		newCustomerPage = homePage1.openNewCustomerPage(driver);
